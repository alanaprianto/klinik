...
class ProvinceTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($countries as $country){
            \Illuminate\Support\Facades\DB::table('countries')->insert(['name' => $country[0], 'code' => $country[1]]);
        }

        foreach ($provices as $provice) {
            \Illuminate\Support\Facades\DB::table('provinces')->insert(['code' => $provice[0], 'name' => $provice[1]]);
        }

        foreach ($cities as $city) {
            \Illuminate\Support\Facades\DB::table('cities')->insert(['code' => $city[0], 'sub_code' => $city[1], 'name' => $city[2], 'province_id' => \App\Province::where('code', $city[1])->first()->id]);
        }

        foreach ($districts as $district) {
            $city = \App\City::where('code', $district[1])->first();
            \Illuminate\Support\Facades\DB::table('districts')->insert(['code' => $district[0], 'sub_code' => $district[1], 'name' => $district[2], 'city_id' => $city ? $city->id : null]);
        }
