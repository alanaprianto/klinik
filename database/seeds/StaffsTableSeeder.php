...
/*        $job_perawat = \App\StaffJob::where('name', 'Perawat')->first();
        ...
        $syahril = ['nik' => '22222', 'full_name' => 'Syahril', 'gender' => 'male', 'staff_job_id' => $job_dokter->id, 'hospital_id' => $hospital->id];
        $lucky = ['nik' => '33333', 'full_name' => 'Lucky', 'gender' => 'male' , 'staff_job_id' => $job_dokter->id, 'hospital_id' => $hospital->id];
