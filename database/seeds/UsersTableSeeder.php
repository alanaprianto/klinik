...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $poli_gigi = ['email' => 'poli_gigi@klinik.com', 'password' => bcrypt('qwe123@@'), 'username' => 'poli_gigi'];

        \Illuminate\Support\Facades\DB::table('users')->insert([$admin, $loket, $admin_loket ,$poli_umum, $admin_poli_umum ,$poli_anak ,$admin_poli_anak ,$kasir,$admin_kasir ,$apotek, $admin_apotek, $penata_jasa, $poli_gigi]);
    }
}
