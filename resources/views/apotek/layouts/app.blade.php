                    ...
                    <ul class="metismenu" id="module-left-menu">
                        ...
                        <li>
                            ...
                            <ul class="module-left-dropdown" aria-expanded="false">
                                <li><a href="{{url('/apotek/obat')}}">Database Obat & Alkes</a></li>
                                <li><a href="{{url('/apotek/inventory')}}">Database Non Alkes</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{url('/apotek/pengunjung')}}">
                                <span class="sidebar-nav-item-icon fa fa-male fa-fw"></span>
                                <span class="sidebar-nav-item">Pengunjung</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url('/apotek/profil')}}">
                                <span class="sidebar-nav-item-icon fa fa-file-image-o fa-fw"></span>
