            ...
            <div>
                <form class="m-t" role="form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="field">
                        ...
                        <p>Klik tombol berikut untuk mengajukan pendaftaran.</p>
                    </div>
                    <a class="ui fluid large teal button" style="background-color: #FE6860" href="{{ route('register') }}">Create
                        an account</a>
                </form>
                <p class="m-t">
                    <small>Teknoland for medical</small>
                </p>
            </div>
