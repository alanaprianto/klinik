...
<div class=" text-center">
    ...
    <div class="panel-body">
        <a class="btn btn-print" type="button" data-type="bpjs" href="javascript:;"><img src="img/icon-bpjs.png"
                                                                                         style="height: 200px"></a>
        <a class="btn btn-print" type="button" href="javascript:;" data-type="umum"><img src="img/icon-umum.png"
                                                                                         style="height: 200px"></a>
        <a class="btn  btn-print" type="button" href="javascript:;" data-type="contractor"><img
                    src="img/icon-contractor.png" style="height: 200px"></a>
    </div>
    <h1></h1>
