...
class ApiPaymentController extends Controller
{
    ...
    public function index()
    {
        $response = [];
        try {
            $registers = Register::with(['patient', 'references', 'paymentHistories', 'references.poly', 'references.payments', 'references.payments.service', 'references.medicalRecords'])->whereNotNul('payment_status')->get();
