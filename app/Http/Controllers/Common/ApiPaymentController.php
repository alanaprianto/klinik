...
class ApiPaymentController extends Controller
{
    ...
    public function index()
    {
        $response = [];
        try {
            $registers = Register::with(['patient', 'references', 'paymentHistories', 'references.poly', 'references.payments', 'references.payments.service', 'references.payments.inventory', 'references.medicalRecords'])->whereNotNull('payment_status')->get();
